# 한국 화장품 원료 회사 분석 대시보드

DART(전자공시시스템) API를 활용하여 한국의 화장품 원료 관련 회사들을 자동으로 분류하고, 재무 실적을 수집/분석하는 Streamlit 대시보드입니다.

## 주요 기능

- **자동 회사 분류**: KSIC 산업코드 + 키워드 혼합 방식으로 화장품 원료 회사 자동 분류
- **재무 데이터 수집**: 2021-2025년(최근 5년) 재무제표 자동 수집
- **인터랙티브 대시보드**:
  - 매출/영업이익 트렌드 분석
  - 수익성 지표 분석 (영업이익률, 순이익률)
  - 산업 평균 대비 분석
- **데이터 관리**: 캐시 관리, 데이터 새로고침, CSV/Excel 내보내기
